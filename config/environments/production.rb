Rails.application.configure do
  ...
  config.action_mailer.default_url_options = { :host => 'www.tenpoundbackpack.com' }
  ...
  config.action_mailer.smtp_settings = {
    ...
    :port                 => 587,
    :domain               => 'tenpoundbackpack.com',
    :user_name            => 'admin@tenpoundbackpack.com',
  ...
  :email => {
    ...
    :sender_address => %{"notifier" <admin@tenpoundbackpack.com>},
