class RecommendationsController < ApplicationController
  ...
  def index
    @recommendations = Recommendation.all.group_by(&:post_category_id)
  end
  ...
  private
    ...
    def recommendation_params
      params.require(:recommendation).permit(:title, :url, :picture_url, :feature_one, :feature_two, :feature_three, :post_category_id, :retailer)
    end
end
