class PostsController < ApplicationController
  ...
  private
    ...
    def post_params
      params.require(:post).permit(:content, :title, :thumbs_up, :thumbs_down, :large_image_url, :thumb_image_url, :meta_title, :meta_desc, :category, :user_id, :bootsy_image_gallery_id)
    end
end
